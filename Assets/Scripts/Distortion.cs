...
public class Distortion : MonoBehaviour
{
    ...
    public float distortionIntensity = 50f;  // Ajusta la intensidad de la distorsi�n
    ...
    private void Start()
    {
        // Aseg�rate de que el PostProcessVolume tenga el componente LensDistortion
    ...
    {
        // Activa el efecto de distorsi�n
        ...
        // Desactiva el efecto de distorsi�n
